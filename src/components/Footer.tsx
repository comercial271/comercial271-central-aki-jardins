  ...
  return (
    <footer className="bg-forest-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8 mb-8">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-bold text-lg">AKI Jardins</span>
          </div>
          <p className="text-gold-500 text-sm italic">Soluções em Paisagismo — LTDA</p>
          <p className="text-white/50 text-xs mt-1">Rio do Sul · Laurentino · Ituporanga · Lontras — SC</p>
        </div>
        <div className="text-center">
          <p className="text-white/60 text-sm">Central construída na Mentoria Selva Premium</p>
          <p className="text-white/40 text-xs mt-1">Sessão 1: 13/05/2026 | Sessão 2: 14/05/2026 | Check-in: 11/06/2026</p>
        </div>
      ...
      <div className="border-t border-forest-700 pt-6 text-center">
        <p className="text-white/30 text-xs">© 2026 AKI Jardins Soluções e Paisagismo LTDA | Selva Premium. Todos os direitos reservados.</p>
      </div>
    </footer>
  )
}
